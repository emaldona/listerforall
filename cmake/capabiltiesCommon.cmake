...
macro(capabilties_build)
    ...
    capabilties_build_java()
    capabilties_build_jars()
    capabilties_build_javadocs()
endmacro()

macro(capabilties_build_globs)
    file(GLOB_RECURSE _JAVA_SOURCES *.java)
...
macro(capabilties_build_includes)
...
macro(capabilties_build_c_file C_FILE C_OUTPUT C_TARGET C_DIR)
...
macro(capabilties_build_c)
    foreach(C_SOURCE ${C_SOURCES})
        ...
        capabilties_build_c_file("${C_SOURCE}" "${C_OUTPUT}" "${C_TARGET}" "${C_DIR}")
...
macro(capabilties_build_jars)
    # Note that build/MANIFEST.MF is generated by JSSConfig.cmake's
    # capabilties_config_version macro. Further, this doesn't yet build a reproducible
    # JAR.
    add_custom_command(
...
macro(capabilties_build_javadocs)
