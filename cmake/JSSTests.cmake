macro(jss_tests)
    ...
    jss_test_java(
        NAME "Lister"
        COMMAND "org.mozilla.jss.tests.Lister" "${RESULTS_NSSDB_OUTPUT_DIR}" "${PASSWORD_FILE}"
        DEPENDS "JSSProvider"
    )
    jss_test_java(
        NAME "ListerForAll"
        COMMAND "org.mozilla.jss.tests.ListerForAll" "${RESULTS_NSSDB_OUTPUT_DIR}" "${PASSWORD_FILE}"
        DEPENDS "JSSProvider"
    )
