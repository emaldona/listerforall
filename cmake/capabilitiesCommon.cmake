...
macro(capabilities_build_globs)
...
macro(capabilities_build_includes)
...
macro(capabilities_build_c_file C_FILE C_OUTPUT C_TARGET C_DIR)
...
macro(capabilities_build_c)
    foreach(C_SOURCE ${C_SOURCES})
        ...
        capabilities_build_c_file("${C_SOURCE}" "${C_OUTPUT}" "${C_TARGET}" "${C_DIR}")
...
macro(capabilities_build_jars)
    # Note that build/MANIFEST.MF is generated by JSSConfig.cmake's
    # capabilities_config_version macro. Further, this doesn't yet build a reproducible
    # JAR.
    add_custom_command(
...
macro(capabilities_build_javadocs)
